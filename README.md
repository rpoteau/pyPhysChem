...
*If you use pieces of code of this github repository that turned out to be decisive to your work, or that have been useful for your self-learning, please cite it as follows*:
 ...
 S. Christodoulou, N. Bernard, I. C. Gerber, F. Jolibois and R. Poteau, *Python in the Physical Chemistry lab (pyPhysChem) github repository*, release v. 1.9.0 (2024), doi: [10.5281/zenodo.8396813](https://doi.org/10.5281/zenodo.8396813)
