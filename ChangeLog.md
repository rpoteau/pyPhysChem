...
## **2026.09.04 [2.3.2, 2.3.3, 2.3.4]** "Ato1PS"
...
- new `ML-Slides/Cargese.pdf` lecture

## **2026.04.09 [2.2.12]** "New AuNP RDF data"

### Added

new Author, Sara Mokhtari

### Changed

- replaced `ML-data/RDFs/simulRDF/` data, with those calculated with DebyeCalculator

## **2026.04.05 [2.2.11]** "cargese refinement"

### Changed

- `OrNano2026.ipynb` notebook updated with new questions
